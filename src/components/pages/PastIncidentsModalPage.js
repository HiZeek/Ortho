...
const PastIncidentsModalPage = (props) => {
  return (
    <PastIncidentsModal onClose={props.onClose}>
      <div className="bg-white laptop:w-[953px] laptop:h-[724.91px] tablet:w-[768px] tablet:h-[700px] phone:w-[450px] phone:h-[422px] overflow-auto tablet:p-14 phone:p-4 tablet:rounded-2xl phone:rounded">
        <img
